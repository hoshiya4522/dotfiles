...
bindkey("n", "<A-1>", ":b1<CR>", nnr)
bindkey("n", "<A-2>", ":b2<CR>", nnr)
bindkey("n", "<A-3>", ":b3<CR>", nnr)
bindkey("n", "<A-4>", ":b4<CR>", nnr)
bindkey("n", "<A-5>", ":b5<CR>", nnr)
bindkey("n", "<A-6>", ":b6<CR>", nnr)
bindkey("n", "<A-7>", ":b7<CR>", nnr)
bindkey("n", "<A-8>", ":b8<CR>", nnr)
bindkey("n", "<A-9>", ":b9<CR>", nnr)
bindkey("n", "<A-0>", ":b10<CR>", nnr)
