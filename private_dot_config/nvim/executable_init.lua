...
vim.pack.add({
	...
	{ src = "https://github.com/levouh/tint.nvim" },
...
local rel = "#7aa2f7" -- because im blind /s
vim.api.nvim_set_hl(0, "LineNrAbove", { fg = rel })
vim.api.nvim_set_hl(0, "LineNrBelow", { fg = rel })
...
require("obsidian").setup {
	...
	workspaces = {
		{
			name = "Archive",
			path = "/home/hoshiya4522/Documents/Library/MISC/Obsidian_Vaults/Archive",
		},
	},
}
